...
|----|-------|--------|--------|----------|
| [FD-017](FD-017_ASSEMBLYDIFF_TIER2_STRUCTURAL.md) | AssemblyDiff Tier 2 — Structured Diff Records, File Split, PInvokeInfo, Generic Constraints | Pending Verification | High | Medium |
